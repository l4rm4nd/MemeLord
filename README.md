...
| `ENABLE_PUBLIC_FEED`             | Set to `True` if you want to enable a public feed for anonymous users. Authenticated users are asked whether an uplaoded meme shall be public or not with second approval. | `False`         | Optional            |
